...
# TODO: Create folder with file suffix; too many files per configuration otherwise
...
AUTOBENCH_SYS_SINGLE_FILEPATH="$AUTOGENERATED_FILES_DIR/autobench_sys_single_$FILE_SUFFIX.conf"
AUTOBENCH_SYS_MULTI_FILEPATH="$AUTOGENERATED_FILES_DIR/autobench_sys_multi_$FILE_SUFFIX.conf"
AUTOBENCH_DBT2_SINGLE_FILEPATH="$AUTOGENERATED_FILES_DIR/autobench_dbt2_single_$FILE_SUFFIX.conf"
AUTOBENCH_DBT2_MULTI_FILEPATH="$AUTOGENERATED_FILES_DIR/autobench_dbt2_multi_$FILE_SUFFIX.conf"
